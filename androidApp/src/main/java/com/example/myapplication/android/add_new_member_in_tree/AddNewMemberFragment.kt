...
class AddNewMemberFragment : Fragment(R.layout.fragment_add_new_member) {
    ...
    private fun getInfoFromView(): UserTreeInfo {
        with(binding) {
            ...
            userTreeInfo.uid = DIContainer.treeDbRef.child("userInfoArray").push().key
            return userTreeInfo
        }
    }
