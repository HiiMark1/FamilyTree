package com.example.myapplication.android.tree.member_of_tree.edit_member_of_tree
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            btnSave.setOnClickListener {
                val treeList = tree1.userInfoArray.toMutableList()
    ...
    private fun setUserInfoView(user: UserTreeInfo) {
        with(binding) {
            ...
            if (user.birthDate != null) {
                val array = user.birthDate!!.split("/")
